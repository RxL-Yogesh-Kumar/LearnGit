                        ...
                        <div class="row">
                            <div class="col-auto">
                                <figure class="figure" id="fif">
                                    <asset:image src="${topic.createdBy.photo}" width="80px" height="90px"/>
                                </figure>
                            </div>
                            <div class="col">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <a href="#" class="card-link">${topic.subscribers.size()}</a>

                                    </div>

                                    <div class="col">
                                        <h9 class="text-muted">Topics</h9>
                                        <a href="#" class="card-link">${topic.createdBy.topics.size()}</a>
                ...
                <g:each in="${subList}" var="it">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-auto">
                                <figure class="figure" id="fif">
                                    <asset:image src="${it.user.photo}" width="80px" height="90px"/>
                                </figure>
                            </div>
                            <div class="col">
                                <div class="row">
                ...
                <g:each in="${resList}">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-auto">
                                <figure class="figure" id="fif">
                                    <asset:image src="${it.topic.createdBy.photo}" width="80px" height="90px"/>
                                </figure>
                            </div>
                            <div class="col">
